    ...
    <footer className="bg-black text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed opacity-80">
            A contemporary art gallery dedicated to exhibitions, events, and
            cultural storytelling across generations and borders.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/exhibitions" className="hover:text-green-500 transition">
                Exhibitions
              </Link>
            </li>
            <li>
              <Link to="/events" className="hover:text-green-500 transition">
                Events
              </Link>
            </li>
            <li>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-xs opacity-70">
          © {new Date().getFullYear()} Kachi James Gallery. All rights reserved.
        </p>
